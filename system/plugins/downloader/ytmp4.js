...
module.exports = {
     ...
     if (!/youtube.com|youtu.be/.test(text) || !text) throw "> Masukan Link YouTube nya"
     ...
     if (limit.oversize) throw `> Gagal mengunduh audio karena telah ukuran file untuk pengguna gratis *( ${size} )*, upgrade status mu ke premium agar dapat mengunduh audio hingga *1GB* !`;
     m.reply({
       video: data.download,
       caption: cap
     })
