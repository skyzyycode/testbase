module.exports = {
  ...
  async run(m, {
     ...
     let who = m.quoted ? m.quoted.sender : m.mentions.length > 0 ? m.mentions[0] : false
     ...
     await sock.groupParticipantsUpdate(m.cht, [who], "remove").then((a) => m.reply("> Success mengeluar member jomok 😹"));
    }
}