        ...
        if (text.includes("--get")) {
            ...
            if (!isNaN(input)) {
                ...
                try {
                    ...
                    m.reply(`> Plugins ${file} Tidak ditemukan, cek kembali list Plugins yang kamu simpan`);
                }
            } else {
                try {
                    ...
                    m.reply(`> Plugins ${input} Tidak ditemukan, cek kembali list Plugins yang kamu simpan`);
                }
            }
