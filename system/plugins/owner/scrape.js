        ...
        if (text.includes("--get")) {
            ...
            if (!isNaN(input)) {
                ...
                try {
                    ...
                    m.reply(`> Scrape ${list[parseInt(input) - 1]} Tidak ditemukan, cek kembali list Scrape yang kamu simpan`);
                }
            } else {
                try {
                    ...
                    m.reply(`> Scrape ${input} Tidak ditemukan, cek kembali list Scrape yang kamu simpan`);
                }
            }
